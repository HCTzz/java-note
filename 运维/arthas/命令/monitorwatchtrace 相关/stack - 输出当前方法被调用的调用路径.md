<center><font size="4"><b>输出当前方法被调用的调用路径</b></font></center>
...
### [#](https://arthas.aliyun.com/doc/stack.html#参数说明)参数说明
...
### [#](https://arthas.aliyun.com/doc/stack.html#使用例子)使用例子

#### [#](https://arthas.aliyun.com/doc/stack.html#启动-demo)启动 Demo

启动[快速入门](https://arthas.aliyun.com/doc/quick-start.html)里的`math-game`。

#### [#](https://arthas.aliyun.com/doc/stack.html#stack-1)stack
...
#### [#](https://arthas.aliyun.com/doc/stack.html#据条件表达式来过滤)据条件表达式来过滤
...
#### [#](https://arthas.aliyun.com/doc/stack.html#据执行时间来过滤)根据执行时间来过滤
