<center><font size="4"><b>方法内部调用路径，并输出方法路径上的每个节点上耗时</b></font></center>
...
# [#](https://arthas.aliyun.com/doc/trace.html#参数说明)参数说明
...
### [#](https://arthas.aliyun.com/doc/trace.html#注意事项)注意事项
...
### [#](https://arthas.aliyun.com/doc/trace.html#使用参考)使用参考

#### [#](https://arthas.aliyun.com/doc/trace.html#启动-demo)启动 Demo

启动[快速入门](https://arthas.aliyun.com/doc/quick-start.html)里的`math-game`。

#### [#](https://arthas.aliyun.com/doc/trace.html#trace-函数)trace 函数
...
#### [#](https://arthas.aliyun.com/doc/trace.html#trace-次数限制)trace 次数限制
...
#### [#](https://arthas.aliyun.com/doc/trace.html#包含-jdk-的函数)包含 jdk 的函数
...
#### [#](https://arthas.aliyun.com/doc/trace.html#据调用耗时过滤)根据调用耗时过滤
...
#### [#](https://arthas.aliyun.com/doc/trace.html#trace-多个类或者多个函数)trace 多个类或者多个函数
...
#### [#](https://arthas.aliyun.com/doc/trace.html#排除掉指定的类)排除掉指定的类
...
### [#](https://arthas.aliyun.com/doc/trace.html#动态-trace)动态 trace
...
### [#](https://arthas.aliyun.com/doc/trace.html#trace-结果时间不准确问题)trace 结果时间不准确问题
...
1. 没有被 trace 到的函数。比如`java.*` 下的函数调用默认会忽略掉。通过增加`--skipJDKMethod false`参数可以打印出来。
   ...
   ```
   trace com.wisdytech.lcdpbase.tenant.service.notransaction.impl.SysTenantUserPlatServiceImpl getUserByUsername -n 1
   ```
...
#### [#](https://arthas.aliyun.com/doc/trace.html#使用-v-参数打印更多信息)使用 -v 参数打印更多信息
