<center><font size="4"><b>方法执行数据的时空隧道，记录下指定方法每次调用的入参和返回信息，并能对这些不同的时间下调用进行观测</b></font></center>
...
#### [#](https://arthas.aliyun.com/doc/tt.html#记录调用)记录调用
...
#### [#](https://arthas.aliyun.com/doc/tt.html#检索调用记录)检索调用记录
...
#### [#](https://arthas.aliyun.com/doc/tt.html#查看调用信息)查看调用信息
...
#### [#](https://arthas.aliyun.com/doc/tt.html#重做一次调用)重做一次调用
...
#### [#](https://arthas.aliyun.com/doc/tt.html#观察表达式)观察表达式
