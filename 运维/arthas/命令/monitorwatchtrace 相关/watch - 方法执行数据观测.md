<center><font size="4"><b>方法执行数据观测</b></font></center>
...
### [#](https://arthas.aliyun.com/doc/watch.html#参数说明)参数说明
...
### [#](https://arthas.aliyun.com/doc/watch.html#使用参考)使用参考

#### [#](https://arthas.aliyun.com/doc/watch.html#启动-demo)启动 Demo

启动[快速入门](https://arthas.aliyun.com/doc/quick-start.html)里的`math-game`。

#### [#](https://arthas.aliyun.com/doc/watch.html#观察函数调用返回时的参数、this-对象和返回值)观察函数调用返回时的参数、this 对象和返回值
...
#### [#](https://arthas.aliyun.com/doc/watch.html#观察函数调用入口的参数和返回值)观察函数调用入口的参数和返回值
...
#### [#](https://arthas.aliyun.com/doc/watch.html#同时观察函数调用前和函数返回后)同时观察函数调用前和函数返回后
...
#### [#](https://arthas.aliyun.com/doc/watch.html#调整-x的值-观察具体的函数参数值)调整`-x`的值，观察具体的函数参数值 
...
#### [#](https://arthas.aliyun.com/doc/watch.html#条件表达式的例子)条件表达式的例子
...
#### [#](https://arthas.aliyun.com/doc/watch.html#观察异常信息的例子)观察异常信息的例子
...
#### [#](https://arthas.aliyun.com/doc/watch.html#按照耗时进行过滤)按照耗时进行过滤
...
#### [#](https://arthas.aliyun.com/doc/watch.html#观察当前对象中的属性)观察当前对象中的属性
...
#### [#](https://arthas.aliyun.com/doc/watch.html#获取类的静态字段、调用类的静态函数的例子)获取类的静态字段、调用类的静态函数的例子
...
#### [#](https://arthas.aliyun.com/doc/watch.html#排除掉指定的类)排除掉指定的类
...
#### [#](https://arthas.aliyun.com/doc/watch.html#不匹配子类)不匹配子类
...
#### [#](https://arthas.aliyun.com/doc/watch.html#使用-v-参数打印更多信息)使用 -v 参数打印更多信息
