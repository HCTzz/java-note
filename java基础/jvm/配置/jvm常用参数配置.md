...
![img](E:\learn\git\repository\笔记\java-note\java基础\jvm\配置\img\内存区域常见配置参数.png)

![堆参数](E:\learn\git\repository\笔记\java-note\java基础\jvm\配置\img\java_jvm_heap_parameters.png)

![垃圾回收器参数](E:\learn\git\repository\笔记\java-note\java基础\jvm\配置\img\java_jvm_garbage_collector_parameters.png)
...
![项目中垃圾回收器常用配置](E:\learn\git\repository\笔记\java-note\java基础\jvm\配置\img\java_jvm_suggest_parameters.png)

###  常用组合

​					第三行应为：ParNew

![垃圾回收器常用组合](E:\learn\git\repository\笔记\java-note\java基础\jvm\配置\img\java_jvm_compose_garbage_collector.png)
